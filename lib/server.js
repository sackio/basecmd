  ...
  */
  ...
  , function(cb){
      return S.setupPublicRoutes({
        'express': S.express
      , 'paths': S.settings[S.settings.name].public
      }, Belt.cw(cb, 0));
    }
  , function(cb){
  ...
  , function(cb){
      return S.setupViews({
        'express': S.express
      , 'paths': S.settings[S.settings.name].views
      }, Belt.cw(cb, 0));
    }
  , function(cb){
  ...
  , function(cb){
      return S.setupModels(_.extend({}, S.settings, {
        'paths': S.settings[S.settings.name].models
      }), Belt.cw(cb, 0));
    }
  , function(cb){
  ...
  , function(cb){
      return S.setupHelpers(_.extend({}, S.settings, {
        'paths': S.settings[S.settings.name].helpers
      }), Belt.cw(cb, 0));
    }
  , function(cb){
      return S.setupControllers(_.extend({}, S.settings, {
        'paths': S.settings[S.settings.name].controllers
      }), Belt.cw(cb, 0));
    }
  ], function(err){
