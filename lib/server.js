  ...
  */
  ...
  , function(cb){
      return S.setupHelpers(_.extend({}, S.settings, {
        'paths': S.settings.spark.helpers
      }), Belt.cw(cb, 0));
    }
  , function(cb){
      return S.setupControllers(_.extend({}, S.settings, {
        'paths': S.settings.spark.controllers
      }), Belt.cw(cb, 0));
    }
  ], function(err){
